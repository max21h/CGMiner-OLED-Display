...
while True:
    ...
    try:
        ...
        if withImage:
            draw.bitmap((x, top+41), btcLogo, fill=1)
            draw.text((x+25, top+44), "Check CGMiner", font=font, fill=255)
            draw.text((x+25, top+52), "process !", font=font, fill=255)
        else:
            draw.text((x, top+44), "Check CGMiner", font=font, fill=255)
            draw.text((x, top+52), "process !", font=font, fill=255)
